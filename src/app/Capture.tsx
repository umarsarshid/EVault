    ...
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-sm text-sand-700 dark:text-sand-300">
          Capture a photo directly from your camera. The raw blob stays in memory for now.
        </p>
      </header>
          ...
          {photoUrl ? (
            <div className="space-y-3">
              ...
              <div className="text-xs text-sand-600 dark:text-sand-400">
                {photoBlob ? `${photoBlob.type || 'image/jpeg'} · ${Math.round(photoBlob.size / 1024)} KB` : null}
              </div>
            </div>
          ) : (
